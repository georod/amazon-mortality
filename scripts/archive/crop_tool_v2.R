...
#rv_match <- rv_match[rv_match$ryear %in% c(2010:2012),] # all completed
#rv_match <- rv_match[rv_match$ryear %in% c(2013:2015),]
#rv_match <- rv_match[rv_match$ryear %in% c(2016:2018),]
#rv_match <- rv_match[rv_match$ryear %in% c(2019),]
rv_match <- rv_match[rv_match$ryear %in% c(2001),]
