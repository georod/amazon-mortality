...
# - jindex corresponds to rv_match records number
# - This code needs revising given that if rv_match changes the j index will no longer work.
# - I will have to do Para state separately
# - The j indices reflect about 15-hour processing blocks
...
foreach(j=90:91, .packages=c('doParallel','foreach','terra', 'sf')) %do% {
